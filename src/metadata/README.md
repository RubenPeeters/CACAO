 ...
 * [cacao.yml](cacao.yml)
     * Determines how your purl.obolibrary.org/obo/cacao/ redirects will be handled
     ...
     * Paste in the contents of [cacao.yml](cacao.yml)
 ...
 * [cacao.md](cacao.md)
     ...
     * Paste in the contents of [cacao.md](cacao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
